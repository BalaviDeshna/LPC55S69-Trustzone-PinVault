...
5. flash the _s project first (this automatically flashes both the secure and the non-secure binaries together)
<br><br>
...
> the Secure debug configuration automatically includes the secure binary in the flash sequence, depending on the IDE configuration.
